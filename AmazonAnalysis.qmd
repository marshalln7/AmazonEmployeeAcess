...
tuning_grid <- grid_regular(penalty(), mixture(), levels = L) ## L^2 total tuning possibilities13

## Split data for CV15
folds <- vfold_cv(myDataSet, v = 5, repeats=1)

## Run the CV18
CV_results <- amazon_workflow %>%19
tune_grid(resamples=folds,20
grid=tuning_grid,21
metrics=metric_set(roc_auc, f_meas, sens, recall, spec,22
precision, accuracy))
```
